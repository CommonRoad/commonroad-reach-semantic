...
void export_benchmark(py::module &m) {
    py::class_<ReachBenchmarkResults>(m, "ReachBenchmarkResults")
        ...
        .def_property_readonly(
            "automaton_creation_time",
            [](const ReachBenchmarkResults &r) { return static_cast<double>(r.automaton_creation_time) / 1'000'000; })
    ...
    py::class_<ReachComputationTimes>(m, "ReachComputationTimes")
        ...
        .def_property_readonly(
            "propagation",
            [](const ReachComputationTimes &r) { return static_cast<double>(r.propagation) / 1'000'000; })
        .def_property_readonly(
            "splitting", [](const ReachComputationTimes &r) { return static_cast<double>(r.splitting) / 1'000'000; })
        .def_property_readonly(
            "partitioning",
            [](const ReachComputationTimes &r) { return static_cast<double>(r.partitioning) / 1'000'000; })
        .def_property_readonly(
            "collision_check",
            [](const ReachComputationTimes &r) { return static_cast<double>(r.collision_check) / 1'000'000; })
        .def_property_readonly("merge",
                               [](const ReachComputationTimes &r) { return static_cast<double>(r.merge) / 1'000'000; })
