...
void export_reach(py::module &module) {
    export_reachable_set_interface(module);
    export_reachable_set_labeler(module);
}

void export_reachable_set_interface(py::module &module) {
    py::class_<SemanticReachableSet, shared_ptr<SemanticReachableSet>>(module, "SemanticReachableSet")
    ...
    py::class_<SemanticLabelingReachableSet, shared_ptr<SemanticLabelingReachableSet>, SemanticReachableSet>(
        module, "SemanticLabelingReachableSet")
        .def(py::init<SemanticConfigurationPtr const &, CollisionCheckerPtr const &, SemanticModelPtr const &,
                      TrafficRuleInterfacePtr const &>(),
             py::arg("configuration"), py::arg("collision_checker"), py::arg("semantic_model"),
    ...
    py::class_<SemanticOTFReachableSet, shared_ptr<SemanticOTFReachableSet>, SemanticReachableSet>(
        module, "SemanticOTFReachableSet")
        .def(py::init<SemanticConfigurationPtr const &, CollisionCheckerPtr const &, SemanticModelPtr const &,
                      TrafficRuleInterfacePtr const &>(),
             py::arg("configuration"), py::arg("collision_checker"), py::arg("semantic_model"),
             py::arg("traffic_rule_interface"))
...
void export_reachable_set_labeler(py::module &module) {
    py::class_<ReachableSetLabeler, shared_ptr<ReachableSetLabeler>>(module, "ReachableSetLabeler")
