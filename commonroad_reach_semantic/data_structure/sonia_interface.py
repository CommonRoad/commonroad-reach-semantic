...
class SONIAInterface:
    ...
    def __init__(self, config: Configuration):
        ...
        self.time_start = config.planning.step_start
        self.time_horizon = config.planning.steps_computation + config.sonia.time_steps_computation_extra
        ...
        # ================    register scenario for automata prediction
        ...
        # update parameters for automata
    ...
    def postprocess_prediction(self):
        ...
        for struct_obstacle in self.list_structs_obstacles_predicted:
            ...
            # automata prediction is attached to dynamic obstacles in the scenario
