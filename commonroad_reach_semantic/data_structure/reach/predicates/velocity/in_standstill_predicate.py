...
class InStandstillPredicate(predicate.Predicate):
    def __init__(self, negated: bool):
        super().__init__(negated)

    def to_proposition(self) -> str:
        return Prop.in_standstill()
    ...
    def _restrict_reach_node_forbidden(self, step: int, reach_node: ReachNode, semantic_model: SemanticModel,
        ...
        # todo: below -v_err (but this is driving backwards, so it should be forbidden anyway)
        return [reach_node]
