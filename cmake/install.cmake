...
foreach (fc_target spdlog yaml-cpp)
...
set(crreachsem_install_cmakedir ${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME})

set(crreachsem_config_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}Config.cmake)
set(crreachsem_version_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}ConfigVersion.cmake)

configure_package_config_file(
        ${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}Config.cmake.in
        ${crreachsem_config_file}
        INSTALL_DESTINATION ${crreachsem_install_cmakedir})

write_basic_package_version_file(${crreachsem_version_file}
        COMPATIBILITY AnyNewerVersion)

install(FILES ${crreachsem_config_file}
        ${crreachsem_version_file}
        DESTINATION ${crreachsem_install_cmakedir})
...
# Required for export()
foreach (foreign_target spdlog::spdlog yaml-cpp::yaml-cpp)
