...
class BehindObstaclePredicateTest : public testing::Test {
  private:
    void SetUp() override;
  ...
  protected:
    ...
    std::unique_ptr<semantic_reach::BehindObstaclePredicate> positive_pred;
    std::unique_ptr<semantic_reach::BehindObstaclePredicate> negative_pred;
