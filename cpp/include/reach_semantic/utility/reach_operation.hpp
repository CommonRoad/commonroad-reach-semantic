...
ReachNodePtr split_reach_node_wrt_interval(ReachNodePtr const& node, PositionIntervalPtr const& interval,
                                           string const& direction);

/// Returns a list of rectangles in the position domain.
std::vector<ReachPolygonPtr>
project_propagated_sets_to_position_domain(std::vector<ReachNodePtr> const& vec_propagated_set);
...
std::vector<ReachNodePtr> construct_reach_nodes(std::vector<ReachPolygonPtr> const& drivable_area,
                                                std::vector<ReachNodePtr> const& vec_propagated_set,
                                                int const& num_threads);
...
std::vector<ReachNodePtr> discard_nodes_with_short_edge(std::vector<ReachNodePtr> const& vec_nodes,
...
std::vector<ReachNodePtr> connect_children_to_parents(int const& step,
                                                      std::vector<ReachNodePtr> const& vec_nodes,
                                                      int const& num_threads);
}
