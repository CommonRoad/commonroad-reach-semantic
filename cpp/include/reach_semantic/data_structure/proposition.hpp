...
class Proposition {
  public:
    static inline std::string in_lanelet() { return "InLanelet"; }
    ...
    static inline std::string beside() { return "Beside_V"; }

    static inline std::string beside(int const &obstacle_id) { return beside() + std::to_string(obstacle_id); }

    static inline std::string aligned_with() { return "AlignedWith_V"; }
    ...
    static inline std::string in_conflict_with(int const &vehicle_id) {
        return "InConflictWith_V" + std::to_string(vehicle_id);
    }

    static inline std::string in_conflict_by(int const &vehicle_id) {
        return "InConflictBy_V" + std::to_string(vehicle_id);
    }
};
} // namespace semantic_reach