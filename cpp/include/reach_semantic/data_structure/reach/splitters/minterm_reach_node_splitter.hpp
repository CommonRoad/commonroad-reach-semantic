...
namespace semantic_reach {
    ...
    private:
         ...
         * In this case, we label the reachable sets with the target states of the minterms that they satisfy.
         *
         ...
         */
        static std::pair<std::set<Minterm>, std::set<Minterm>>
        _partition_minterms(const Literal &literal,
                            const std::set<Minterm> &minterms);
        ...
        _choose_next_literal(const std::set<Minterm> &minterms, const std::set<Literal> &ignored_literals);
    ...
    public:
        ...
        split_to_minterms(int step, const reach::ReachNodePtr &reachable_set,
                          const std::set<Minterm> &minterms);
    };
}
