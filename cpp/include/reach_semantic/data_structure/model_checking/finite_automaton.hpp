...
class FiniteAutomaton {
  ...
  public:
    ...
    /// Tries to minimize the minterms by combining the conditions of the outgoing edges leading to the same
    /// destination.
    std::vector<std::pair<Minterm, unsigned int>> combined_transitions_from(const std::set<unsigned int> &states);
