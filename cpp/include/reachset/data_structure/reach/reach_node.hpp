...
public:
    ...
    ReachNode(int const& step, ReachPolygonPtr polygon_lon, ReachPolygonPtr polygon_lat,
              ...
              std::vector<std::shared_ptr<ReachNode>> const& source_propagation = {});
    ...
    std::vector<std::shared_ptr<ReachNode>> vec_nodes_parent;
    std::vector<std::shared_ptr<ReachNode>> vec_nodes_child;
    ...
    inline std::shared_ptr<ReachNode> clone() const {
        auto node_clone =
                std::make_shared<ReachNode>(step,
                                            polygon_lon->clone(),
                                            polygon_lat->clone(),
