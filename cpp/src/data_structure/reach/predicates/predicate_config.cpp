...
PredicateConfiguration::PredicateConfiguration(const SemanticConfiguration &config) {
    ...
    traffic_rule_params.standstillError = traffic_rule_config.backward_driving_v_err;
    traffic_rule_params.aBrakingIntersection = traffic_rule_config.acceleration_braking_hard;
    traffic_rule_params.dBrakingIntersection = traffic_rule_config.distance_braking;
