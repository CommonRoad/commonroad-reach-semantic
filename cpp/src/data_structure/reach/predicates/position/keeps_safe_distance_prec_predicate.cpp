...
std::vector<reach::ReachNodePtr> KeepSafeDistancePrecPredicate::_restrict_reach_node_mandatory(
    ...
    for(int i = 0; i<1000; i++) {
        ego_speed = start_velocity + (ego_speed_change * i) / 999.0;
//        1. version
//        double a = -1 * _determine_slope(step, reach_node, world, ego_ccs, ego_speed);
//        double b = 1;
//        double c = _determine_constant_b(step, reach_node, world, ego_ccs, ego_speed);
