...
RightOfObstaclePredicate::RightOfObstaclePredicate(bool negated, size_t obstacle_id, double ego_width)
    : CppPredicate(negated, false), obstacle_id(obstacle_id), ego_width(ego_width) {}
