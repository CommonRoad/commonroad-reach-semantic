...
PyPredicate::PyPredicate(pybind11::object obj_predicate_py)
    : Predicate(obj_predicate_py.attr("needs_lanelets").cast<bool>()), obj_predicate_py(std::move(obj_predicate_py)) {}

std::vector<reach::ReachNodePtr> PyPredicate::restrict_reach_node(
