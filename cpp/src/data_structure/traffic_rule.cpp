...
vector<ReachNodePtr> TrafficRuleInterface::examine_tpl_specifications(int const& step,
                                                                      vector<ReachNodePtr> const& vec_nodes_reach) {
    vector<ReachNodePtr> vec_nodes_keep{};
