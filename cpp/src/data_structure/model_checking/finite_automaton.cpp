...
unsigned int FiniteAutomaton::initial_state() { return _spot_automaton->get_init_state_number(); }
...
bool FiniteAutomaton::is_accepting_state(unsigned int state) { return _spot_automaton->state_is_accepting(state); }
